		...
		<html>
		<head>
			<title>Políticas de Privacidad | Contasus</title>
		...
		<body>
			...
			<div class="textoslegales">
				...
				<p>Google Analytics es un servicio analítico de web prestado por Google, Inc., una compañía de Delaware cuya oficina principal está en 1600 Amphitheatre Parkway, Mountain View (California), CA 94043, Estados Unidos (“Google”). Google Analytics utiliza “cookies”, que son archivos de texto ubicados en su ordenador, para ayudar al website a analizar el uso que hacen los usuarios del sitio web. La información que genera la cookie acerca de su uso del website (incluyendo su dirección IP) será directamente transmitida y archivada por Google. Google usará esta información por cuenta nuestra con el propósito de seguir la pista de su uso del website, recopilando informes de la actividad del website y prestando otros servicios relacionados con la actividad del website y el uso de Internet. Google podrá transmitir dicha información a terceros cuando así se lo requiera la legislación, o cuando dichos terceros procesen la información por cuenta de Google. Google no asociará su dirección IP con ningún otro dato del que disponga Google. Puede Usted rechazar el tratamiento de los datos o la información rechazando el uso de cookies mediante la selección de la configuración apropiada de su navegador, sin embargo, debe Usted saber que si lo hace puede ser que no pueda usar la plena funcionabilidad de este website. Al utilizar este website Usted consiente el tratamiento datos por parte de Google en la forma y para los fines indicados. Los usuarios pueden acceder a la política de privacidad de la red de contenido en  https://www.google.com/intl/es/policies/privacy/.</p>
				<p>Google Adsense:</p>
				<p>Google, como proveedor asociado, utiliza cookies para publicar anuncios en este sitio web. Los usuarios pueden inhabilitar el uso de la cookie de DART a través del anuncio de Google y accediendo a la política de privacidad de la red de contenido https://www.google.com/intl/es/policies/privacy/ .Google utiliza empresas publicitarias asociadas para publicar anuncios cuando visita nuestro sitio web. Es posible que estas empresas usen la información que obtienen de sus visitas a este y otros sitios web (sin incluir su nombre, dirección, dirección de correo electrónico o número de teléfono) para ofrecerle anuncios sobre productos y servicios que le resulten de interés.  Al utilizar este website Usted consiente el tratamiento de datos por parte de Google en la forma y para los fines indicados.</p>
				<p>Si desea más información acerca del uso de cookies y las prácticas de recopilación de información y los procedimientos de aceptación o rechazo por parte del usuario consulte nuestra: POLÍTICA DE COOKIES.</p>
				<h4>DATOS DE TERCEROS</h4>
				<p>En el supuesto de que nos facilite datos de carácter personal de terceras personas, en cumplimiento de lo dispuesto en el artículo 5.4. LOPD, declara haber informado a dichas personas con carácter previo, del contenido de los datos facilitados, de la procedencia de los mismos, de la existencia y finalidad del fichero donde se contienen sus datos, de los destinatarios de dicha información, de la posibilidad de ejercitar los derechos de acceso, rectificación, cancelación u oposición, así como de los datos identificativos de JESUS En este sentido, es de su exclusiva responsabilidad informar de tal circunstancia a los terceros cuyos datos nos va a ceder, no asumiendo JESUS ninguna responsabilidad por el incumplimiento de este precepto por parte del usuario.</p>
				<h4>EJERCICIO DE DERECHOS</h4>
				<p>El titular de los datos podrá ejercer sus derechos de acceso, rectificación, cancelación y oposición dirigiéndose a JESUS: cliente@jesusvicario.es. Dicha solicitud deberá contener los siguientes datos: nombre y apellidos, domicilio a efecto de notificaciones, fotocopia del DNI I o Pasaporte.</p>
				<p>MEDIDAS DE SEGURIDAD</p>
				<p>JESUS ha adoptado todas las medidas técnicas y de organización necesaria para garantizar la seguridad e integridad de los datos de carácter personal que trate, así como para evitar su pérdida, alteración y/o acceso por parte de terceros no autorizados. No obstante lo anterior, el usuario reconoce y acepta que las medidas de seguridad en Internet no son inexpugnables.</p>		
			</div>
		</body>
	</html>